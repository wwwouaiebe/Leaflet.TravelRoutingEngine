...
Consultez la page < https://github.com/wwwouaiebe/leaflet.TravelNotes >
...
sont GraphHopper, Mapbox et Mapzen. Il est également possible d'utiliser OSRM, mais actuellement le serveur OSRM est hors service.
...
peut toujours les retrouver dans l'historique du navigateur**, à moins que vous n'utilisiez le mode navigation privée de votre browser.